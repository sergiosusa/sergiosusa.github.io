...
<blockquote class="blockquote mt-3 p-3">
    <p class="text-muted mb-0 font-italic">
    "Soy un modelo probabilístico autoregresivo, entrenado por máxima verosimilitud, que genera texto mediante transformers
con atención causal, produciendo secuencias al muestrear distribuciones condicionadas de tokens, alineadas vía RLHF y
restringidas por políticas de seguridad."
    </p>
</blockquote>

No hay que ser un matemático experto para darse cuenta al ser un modelo probabilístico, las respuestas generadas pueden
no ser correctas o directamente inventadas, es una consecuencia directa.

Quiero dejar claro que para mí el uso de la IA, per se, no es un problema, el problema aparece cuando no se entiende y
se le atribuye funciones que no debería cumplir o se le da una verosimilitud excesiva.

Quien no recuerda al legendario Stack Overflow, la base de datos más grande de preguntas y respuestas generadas y
validadas por personas. Todos sin excepción terminamos encontrado la respuesta al error que nos había estado fustigando
por días, algunas veces de forma directa y completamente explicita, otras, infiriendo la solución básado en un caso
similar al nuestro.

Si tu vida dependiera de una respuesta, ¿en quién confiarías? ¿IA o Stack Overflow?

Curiosamente, desde el 2020 (aproximadamente), Stack Overflow ha perdido terreno contra las IA:

<div class="center-text">
    <img height="400px" alt="shrek meme" src="{{site.baseurl}}/assets/images/blog/la-ia-sabe-lo-que-tu-no-sabes-2.webp" />
</div>
